...
- (id)copyWithZone:(NSZone *)zone {
    ...
    if (copy != nil) {
        ...
        copy->_bytesReceived = _bytesReceived;
        ...
        copy->_redirectedURL = [_redirectedURL copy];
